...
wasmtime run wasi/preview2/1.wat
...
(component
	...
	(core module $1
		...
		(import "wasi:filesystem/types@0.2.0" "[method]descriptor.get-type" (func $_ZN22wasi_snapshot_preview18bindings4wasi10filesystem5types10Descriptor8get_type10wit_import17h12b26f76378d56caE (type $2)))
		(import "wasi:filesystem/types@0.2.0" "filesystem-error-code" (func $_ZN22wasi_snapshot_preview18bindings4wasi10filesystem5types21filesystem_error_code10wit_import17h32b878f93f498095E (type $2)))
		...
		(import "wasi:filesystem/types@0.2.0" "[method]descriptor.write-via-stream" (func $_ZN22wasi_snapshot_preview18bindings4wasi10filesystem5types10Descriptor16write_via_stream10wit_import17h30b7dd43560975f8E (type $3)))
		(import "wasi:filesystem/types@0.2.0" "[method]descriptor.append-via-stream" (func $_ZN22wasi_snapshot_preview18bindings4wasi10filesystem5types10Descriptor17append_via_stream10wit_import17hb5327b7a6a9970e1E (type $2)))
		(import "wasi:filesystem/types@0.2.0" "[method]descriptor.stat" (func $_ZN22wasi_snapshot_preview18bindings4wasi10filesystem5types10Descriptor4stat10wit_import17h764588a214869cfbE (type $2)))
		(import "wasi:cli/stderr@0.2.0" "get-stderr" (func $_ZN22wasi_snapshot_preview18bindings4wasi3cli6stderr10get_stderr10wit_import17h8fc7853dbba8260eE (type $9)))
		(import "wasi:cli/stdin@0.2.0" "get-stdin" (func $_ZN22wasi_snapshot_preview18bindings4wasi3cli5stdin9get_stdin10wit_import17hfd43447649dabb10E (type $9)))
		(import "wasi:cli/stdout@0.2.0" "get-stdout" (func $_ZN22wasi_snapshot_preview18bindings4wasi3cli6stdout10get_stdout10wit_import17h864b09288a7186d4E (type $9)))
		(import "wasi:io/streams@0.2.0" "[method]output-stream.check-write" (func $_ZN22wasi_snapshot_preview18bindings4wasi2io7streams12OutputStream11check_write10wit_import17ha221d51bbb4364e8E (type $2)))
		(import "wasi:io/streams@0.2.0" "[method]output-stream.write" (func $_ZN22wasi_snapshot_preview18bindings4wasi2io7streams12OutputStream5write10wit_import17h1565b0224aacd1f2E (type $4)))
		(import "wasi:io/streams@0.2.0" "[method]output-stream.blocking-write-and-flush" (func $_ZN22wasi_snapshot_preview18bindings4wasi2io7streams12OutputStream24blocking_write_and_flush10wit_import17h1c3baf292c61ddf5E (type $4)))
		(import "wasi:io/streams@0.2.0" "[method]output-stream.blocking-flush" (func $_ZN22wasi_snapshot_preview18bindings4wasi2io7streams12OutputStream14blocking_flush10wit_import17hde350d2b02818060E (type $2)))
		(func $realloc_via_memory_grow (type $7) (param i32 i32 i32 i32) (result i32)
			(local i32)
			i32.const 0
			local.get 0
			i32.ne
		...
		(func $wasi:cli/run@0.2.0#run (type $9) (result i32)
			call $_ZN22wasi_snapshot_preview13run6_start17hcd53503cde249396E
			i32.const 0
		)
		(func $_ZN22wasi_snapshot_preview15State3ptr17hc3f42be29a6454f5E (type $9) (result i32)
			(local i32)
			block ;; label = @1
				call $get_state_ptr
				local.tee 0
		...
		(func $cabi_import_realloc (type $7) (param i32 i32 i32 i32) (result i32)
			(local i32)
		...
		(func $_ZN22wasi_snapshot_preview19BumpArena5alloc17h5022bdd6cbec68b6E (type $10) (param i32 i32 i32) (result i32)
			(local i32)
			global.get $__stack_pointer
			i32.const 48
			i32.sub
		...
		(func $_ZN22wasi_snapshot_preview111ImportAlloc10with_arena17hf28b35086d884046E (type $6) (param i32 i32 i32)
			(local i32 i32)
			global.get $__stack_pointer
			i32.const 48
			i32.sub
		...
		(func $cabi_export_realloc (type $7) (param i32 i32 i32 i32) (result i32)
			(local i32)
			global.get $__stack_pointer
			i32.const 48
			i32.sub
		...
		(func $_ZN22wasi_snapshot_preview15State11descriptors17hfbf60215365d1fe8E (type $2) (param i32 i32)
			(local i32 i32)
			global.get $__stack_pointer
			i32.const 6176
			i32.sub
		...
		(func $_ZN22wasi_snapshot_preview121stream_error_to_errno17h7eec477ed26e8c16E (type $5) (param i32) (result i32)
			(local i32 i32)
			global.get $__stack_pointer
			i32.const 16
			i32.sub
		...
		(func $fd_write (type $7) (param i32 i32 i32 i32) (result i32)
		...
		(func $_ZN22wasi_snapshot_preview112BlockingMode5write17hada4a5aa44c990c1E (type $8) (param i32 i32 i32 i32 i32)
			(local i32 i32)
			global.get $__stack_pointer
			i32.const 48
			i32.sub
		...
		(func $_ZN22wasi_snapshot_preview15State3new17h5b10f9de6efc7683E (type $9) (result i32)
			(local i32 i32)
			global.get $__stack_pointer
			i32.const 48
			i32.sub
		...
		(func $_ZN22wasi_snapshot_preview18bindings4wasi10filesystem5types10Descriptor4stat17h0fc7bf27cf89e7feE (type $2) (param i32 i32)
		...
		(func $_ZN22wasi_snapshot_preview16macros5print17h654a02fb28d08045E (type $2) (param i32 i32)
			(local i32 i32)
			global.get $__stack_pointer
			i32.const 16
			i32.sub
		...
		(func $_ZN22wasi_snapshot_preview18bindings4wasi2io7streams12OutputStream24blocking_write_and_flush17h751aa90212d94baaE (type $4) (param i32 i32 i32 i32)
			(local i32)
			global.get $__stack_pointer
			i32.const 16
			i32.sub
		...
		(func $_ZN97_$LT$core..option..Option$LT$T$GT$$u20$as$u20$wasi_snapshot_preview1..TrappingUnwrap$LT$T$GT$$GT$15trapping_unwrap17h383cd4347b769b02E (type $5) (param i32) (result i32)
			(local i32)
			global.get $__stack_pointer
			i32.const 48
			i32.sub
		...
		(func $_ZN97_$LT$core..option..Option$LT$T$GT$$u20$as$u20$wasi_snapshot_preview1..TrappingUnwrap$LT$T$GT$$GT$15trapping_unwrap17h3dddbbe3ee3efe1aE (type $11) (param i32 i32) (result i32)
			(local i32)
			global.get $__stack_pointer
			i32.const 48
			i32.sub
		...
		(func $_ZN101_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$wasi_snapshot_preview1..TrappingUnwrap$LT$T$GT$$GT$15trapping_unwrap17h423c3c0b5241dbebE (type $11) (param i32 i32) (result i32)
			(local i32)
			global.get $__stack_pointer
			i32.const 48
			i32.sub
		...
		(func $_ZN101_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$wasi_snapshot_preview1..TrappingUnwrap$LT$T$GT$$GT$15trapping_unwrap17h6c4a34ffedaf54a8E (type $2) (param i32 i32)
			(local i32)
			global.get $__stack_pointer
			i32.const 48
			i32.sub
		...
		(func $_ZN101_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$wasi_snapshot_preview1..TrappingUnwrap$LT$T$GT$$GT$15trapping_unwrap17h776ef183f5046c3bE (type $11) (param i32 i32) (result i32)
			(local i32)
			global.get $__stack_pointer
			i32.const 48
			i32.sub
		...
		(func $_ZN101_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$wasi_snapshot_preview1..TrappingUnwrap$LT$T$GT$$GT$15trapping_unwrap17he8d8674e93fbb965E (type $5) (param i32) (result i32)
			(local i32)
			global.get $__stack_pointer
			i32.const 48
			i32.sub
		...
		(func $_ZN22wasi_snapshot_preview1152_$LT$impl$u20$core..convert..From$LT$wasi_snapshot_preview1..bindings..wasi..filesystem..types..ErrorCode$GT$$u20$for$u20$wasi..lib_generated..Errno$GT$4from17h82bcd1869986fe8aE (type $5) (param i32) (result i32)
			(local i32 i32)
			global.get $__stack_pointer
			i32.const 16
			i32.sub
		...
		(func $_ZN22wasi_snapshot_preview18bindings4wasi2io7streams12OutputStream11check_write17hcae99ee4b0aa5d6bE (type $2) (param i32 i32)
			(local i32 i32 i32)
			global.get $__stack_pointer
			i32.const 16
			i32.sub
		...
		(func $_ZN22wasi_snapshot_preview18bindings4wasi2io7streams12OutputStream5write17h460e1a2336bce089E (type $4) (param i32 i32 i32 i32)
			(local i32)
			global.get $__stack_pointer
			i32.const 16
			i32.sub
		...
		(func $_ZN22wasi_snapshot_preview18bindings4wasi2io7streams12OutputStream14blocking_flush17h3fcb5d4910d26a4aE (type $2) (param i32 i32)
			(local i32 i32)
			global.get $__stack_pointer
			i32.const 16
			i32.sub
		...
		(func $_ZN22wasi_snapshot_preview111descriptors7Streams16get_write_stream17h4f14f0ea61cf2014E (type $2) (param i32 i32)
		...
		(func $_ZN22wasi_snapshot_preview111descriptors11Descriptors3new17h5d829d587b00cc6bE (type $6) (param i32 i32 i32)
		...
		(func $get_state_ptr (type $9) (result i32)
		...
		(func $get_allocation_state (type $9) (result i32)
		...
		(func $_ZN17compiler_builtins3mem6memcpy17hfd20217541c602e1E (type $10) (param i32 i32 i32) (result i32)
	...
	(core module $2
		...
		(func $indirect-wasi:filesystem/preopens@0.2.0-get-directories (type $0) (param i32)
			local.get 0
			i32.const 0
			call_indirect (type $0)
		)
		(func $#func1<indirect-wasi:filesystem/types@0.2.0-_method_descriptor.write-via-stream> (@name "indirect-wasi:filesystem/types@0.2.0-[method]descriptor.write-via-stream") (type $1) (param i32 i64 i32)
			local.get 0
			local.get 1
			local.get 2
			i32.const 1
		...
		(func $#func2<indirect-wasi:filesystem/types@0.2.0-_method_descriptor.append-via-stream> (@name "indirect-wasi:filesystem/types@0.2.0-[method]descriptor.append-via-stream") (type $2) (param i32 i32)
			local.get 0
			local.get 1
			i32.const 2
			call_indirect (type $2)
		)
		(func $#func3<indirect-wasi:filesystem/types@0.2.0-_method_descriptor.get-type> (@name "indirect-wasi:filesystem/types@0.2.0-[method]descriptor.get-type") (type $2) (param i32 i32)
			local.get 0
			local.get 1
			i32.const 3
			call_indirect (type $2)
		)
		(func $#func4<indirect-wasi:filesystem/types@0.2.0-_method_descriptor.stat> (@name "indirect-wasi:filesystem/types@0.2.0-[method]descriptor.stat") (type $2) (param i32 i32)
			local.get 0
			local.get 1
			i32.const 4
			call_indirect (type $2)
		)
		(func $indirect-wasi:filesystem/types@0.2.0-filesystem-error-code (type $2) (param i32 i32)
			local.get 0
			local.get 1
			i32.const 5
			call_indirect (type $2)
		)
		(func $#func6<indirect-wasi:io/streams@0.2.0-_method_output-stream.check-write> (@name "indirect-wasi:io/streams@0.2.0-[method]output-stream.check-write") (type $2) (param i32 i32)
			local.get 0
			local.get 1
			i32.const 6
			call_indirect (type $2)
		)
		(func $#func7<indirect-wasi:io/streams@0.2.0-_method_output-stream.write> (@name "indirect-wasi:io/streams@0.2.0-[method]output-stream.write") (type $3) (param i32 i32 i32 i32)
			local.get 0
			local.get 1
			local.get 2
			local.get 3
		...
		(func $#func8<indirect-wasi:io/streams@0.2.0-_method_output-stream.blocking-write-and-flush> (@name "indirect-wasi:io/streams@0.2.0-[method]output-stream.blocking-write-and-flush") (type $3) (param i32 i32 i32 i32)
			local.get 0
			local.get 1
			local.get 2
			local.get 3
		...
		(func $#func9<indirect-wasi:io/streams@0.2.0-_method_output-stream.blocking-flush> (@name "indirect-wasi:io/streams@0.2.0-[method]output-stream.blocking-flush") (type $2) (param i32 i32)
			local.get 0
			local.get 1
			i32.const 9
			call_indirect (type $2)
		)
		(func $adapt-wasi_snapshot_preview1-fd_write (type $4) (param i32 i32 i32 i32) (result i32)
			local.get 0
			local.get 1
			local.get 2
			local.get 3
	...
	(core module $3
		...
		(import "" "$_____imports" (table $0 11 11 funcref))
	...
	(alias core export 0 "$_____imports" (core table $0))
