(module
 ...
 (data (i32.const 524) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00 \00\00\00~\00l\00i\00b\00/\00d\00a\00t\00a\00v\00i\00e\00w\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data (i32.const 592) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 (export "fibonacci" (func $asc/test.asc/fibonacci))
 (export "recursiveFactorial" (func $asc/test.asc/recursiveFactorial))
 (export "factorial" (func $asc/test.asc/factorial))
 (export "arrayTest1" (func $asc/test.asc/arrayTest1))
 (start $~start)
 (func $asc/test.asc/fibonacci (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $asc/test.asc/recursiveFactorial (param $0 i32) (result i32)
  local.get $0
  i32.const 0
  i32.eq
  if
  ...
  i32.const 1
  i32.sub
  call $asc/test.asc/recursiveFactorial
  local.get $0
  i32.mul
  return
 )
 (func $asc/test.asc/factorial (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  i32.const 1
  local.set $1
     ...
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       block $~lib/object/Object
        ...
        i32.sub
        i32.load $0
        br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/dataview/DataView $invalid
       end
       return
      end
      return
 ...
 (func $asc/test.asc/arrayTest1 (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
